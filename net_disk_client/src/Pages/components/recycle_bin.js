...
const Recycle_bin = () => {
  ...
  const getTrashfiles = () => {
    ...
    axios({
      method: "get",
      url: "/banana/transfer/trash-list",
      params: dataprops,
  ...
  const withdrawDir = (id) => {
    ...
    axios({
      method: "post",
      url: "/banana/transfer/withdraw-dir",
      withCredentials: true,
      data: dataprops,
      header: { "Access-Control-Allow-Origin": "*" },
    })
  ...
  const withdrawFile = (id) => {
    ...
    axios({
      method: "post",
      url: "/banana/transfer/withdraw-file",
      withCredentials: true,
      data: dataprops,
      header: { "Access-Control-Allow-Origin": "*" },
    })
  ...
  const deletefile = (id) => {
    ...
    axios({
      method: "post",
      url: "/banana/transfer/clean-file",
      withCredentials: true,
      data: dataprops,
      header: { "Access-Control-Allow-Origin": "*" },
    })
        ...
        <div>
          <Spin tip="Loading..." spinning={isLoading}>
            <Row type="flex" justify="center">
              <Col xs={6} sm={6} md={12} lg={12} xl={12}></Col>
              <Col
                offset={0}
                className="file_up"
                xs={8}
              ...
              >
                ...
                >
                  <a
                    ...
                    style={{ color: "black", marginRight: "1vw" }}
                  >
                    <RedoOutlined style={{ fontSize: "1.8rem" }} />
                  </a>
                </Popconfirm>
                <Popconfirm
                  title="确定永久删除所选文件?"
                  ...
                  <Row className="list-div">
                    <Col span={12}>
                      ...
                      >
                        ...
                        <a>
                          {" "}
                          {"file_name" in item ? item.file_name : item.dir_name}
                        </a>
                      </Checkbox>
                    </Col>
                        ...
                        {"file_type" in item ? (
                          ...
                          >
                            <a href="" style={{ color: "black" }}>
                              <RedoOutlined style={{ fontSize: "2.4vh" }} />
                            </a>
                          </Popconfirm>
                        ) : (
                          <Popconfirm
