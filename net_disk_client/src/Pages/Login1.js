...
const Login1 = (props) => {
  ...
  const checkLogin = () => {
    ...
    axios({
      method: "post",
      url: "/banana/account-center/common/login",
      data: dataProps,
    })
      .then((res) => {
        setIsLoading(false);
        if (res.data.msg != "登录密码错误") {
          ...
          cookie.save("user_id", res.data.data.id, {
            expires: expire,
            path: "/",
          });
  ...
  const sendcode = () => {
    ...
    axios({
      method: "post",
      url: "/banana/account-center/e-validate",
      data: dataProps,
  ...
  const receiveFiles = () => {
    ...
    axios({
      method: "get",
      url: "/banana/transfer/code-download",
      params: dataprops,
      header: { "Access-Control-Allow-Origin": "*" },
    }).then((res) => {
      if (res.data.msg == "ok") {
  ...
  useEffect(() => {
    axios({
      method: "get",
      url: "/banana/account-center/common/guest",
  ...
  return (
    <div className="main_index">
      <div>
        ...
        <div
          className="uploadFiles animate__animated animate__bounceInLeft"
          hidden={isUpshow}
          id="upload_div"
        >
          <Row type="flex" justify="center">
            <Col offset={0} xs={16} sm={16} md={16} lg={16} xl={16}>
              <Upload {...propss}>
                <Button
                  ...
                  icon={
                    <PlusOutlined
                      style={{ fontSize: "1.7rem", marginLeft: "1.3vw" }}
                    />
                  }
                >
                  上传文件
          ...
          <div className="receive_infor_div">
            ...
            <div className="infor_detailed">
              <Row className="row">
                ...
                >
                  {moment((create_time + expire_time) * 1000).format(
                    "YYYY-MM-DD HH:mm"
                  )}
                </Col>
              </Row>
              ...
              <Row style={{ marginLeft: "1vw" }}>{describe}</Row>
              <Row className="row1">
                <Button
                  onClick={() => {
        ...
        <Modal
          ...
          width="fit-content"
          footer={null}
          onCancel={() => setIsResult(false)}
        >
          <div className="result_div">
            <Result
              status="success"
              title={<h4 style={{ whiteSpace: "nowrap" }}>上传成功!</h4>}
              subTitle={
                <div>
                  您的分享码是:
                  <p
        ...
        <Modal
          ...
          width="fit-content"
          footer={null}
          onCancel={() => setIsUpInforShow(false)}
          bodyStyle={{ borderRadius: "160px" }}
        >
          <div className="infor_title">
            <Input
          ...
          <div className="infor_detailed">
            ...
            <Row className="row1">
              <Button onClick={share} className="Infor_button">
                确认
              </Button>
            </Row>
          </div>
        ...
        <div
          hidden={isForgetshow}
          className="forget_div animate__animated animate__fadeInUp"
        >
          ...
          <div className="form2">
            ...
            >
              ...
              >
                <button className="btn1" onClick={checkChange}>
                  修改
                </button>
              </Form.Item>
            </Form>
      ...
      <Spin tip="Loading..." spinning={isLoading}>
        <div
          hidden={isLoginshow}
          className="container right-panel-active animate__animated animate__fadeInDown"
          id="c1"
        >
          <div className="container__form container--signup">
            <form action="#" className="form" id="form1">
              ...
              <button onClick={checkRegister} className="btn">
                Sign Up
              </button>
            </form>
          </div>
          ...
          <div className="container__form container--signin ">
            ...
            <form action="#" className="form1" id="form2">
              ...
              <div className="input2">
                ...
                <button onClick={() => checkLogin()} className="btn">
                  Sign In
                </button>
              </div>
            </form>
